...
Nk = Nr / 32;
Nr = Nk + 6;
unsigned char temp[16] = {0x00 ,0x01 ,0x02
,0x03 ,0x04 ,0x05 ,0x06 ,0x07 ,0x08 ,0x09
,0x0a ,0x0b ,0x0c ,0x0d ,0x0e ,0x0f};
//d3 ab 85 53 95 25 08 c3 e0 ed 3d 51 f2 13 c6 75
unsigned char temp2[16]= {0xd3 ,0xab ,0x85
,0x53 ,0x95 ,0x25 ,0x08 ,0xc3 ,0xe0 ,0xed
,0x3d ,0x51 ,0xf2 ,0x13 ,0xc6 ,0x75};
for(i=0;i<Nk*4;i++)
{
Key[i]=temp[i];
in[i]=temp2[i];
